I've combined all the provided content into a single `.md` file, incorporating all your sections, badges, and the detailed installation steps including the PyTorch troubleshooting.
...
* **Modular Design:** Codebase is structured into distinct, testable modules for clarity and and maintainability.
